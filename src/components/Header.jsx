...
export function Header({ currentPage, onThemeToggle }) {
  ...
  useEffect(() => {
    ...
    const updateIndicator = () => {
      ...
      nav.style.setProperty('--nav-active-x', `${activeBox.left - navBox.left}px`)
      nav.style.setProperty('--nav-active-y', `${activeBox.top - navBox.top}px`)
      nav.style.setProperty('--nav-active-width', `${activeBox.width}px`)
      nav.style.setProperty('--nav-active-height', `${activeBox.height}px`)
